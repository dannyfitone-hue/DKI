...
export async function addJobUpdate(id,data){
  const row={message:data.message,visible_to_client:data.visible_to_client!==false,created_by:data.created_by||'DKI Restotech Service Team',created_at:new Date().toISOString()};
  if(!supabaseUrl||!serviceKey){
